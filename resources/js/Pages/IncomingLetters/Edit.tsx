...
import { IncomingLetter, LetterNature, Option } from '@/types';
...
export default function Edit({ letter, natures, statuses }: Props) {
    const form = useForm({
    ...
    return (
            ...
            header={
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        ...
                        <h1 className="mt-1 text-2xl font-semibold tracking-normal">Perbarui Surat Diterima</h1>
        ...
        >
            <Head title={`Perbarui ${letter.nomor_agenda}`} />
            ...
            <form onSubmit={submit} className="grid gap-6 xl:grid-cols-[1fr_360px]">
                ...
                <div className="space-y-6">
                    <Card>
                        <CardHeader className="border-b border-slate-200">
                            <CardTitle>Status dan Lampiran</CardTitle>
                        </CardHeader>
